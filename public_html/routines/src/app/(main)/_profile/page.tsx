    ...
    <div className="max-w-container mx-auto px-6 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
        <Card variant="surface">
          <p className="text-caption text-text-secondary mb-2">현재 스트릭</p>
          <p className="text-headline font-bold text-brand-primary">
            {streak?.currentStreak ?? 0}일
          </p>
        </Card>
        <Card variant="surface">
          <p className="text-caption text-text-secondary mb-2">최장 스트릭</p>
          <p className="text-headline font-bold text-brand-primary">
            {streak?.longestStreak ?? 0}일
          </p>
        </Card>
        <Card variant="surface">
          <p className="text-caption text-text-secondary mb-2">학습한 콘텐츠</p>
      ...
      <h2 className="text-title font-semibold mb-4">계정 정보</h2>
      <Card variant="surface">
        <div className="space-y-3 text-body">
          ...
          <div className="flex justify-between">
            <span className="text-text-secondary">구독</span>
            <span className={session?.user?.subscriptionStatus === "active" ? "text-success" : "text-text-secondary"}>
